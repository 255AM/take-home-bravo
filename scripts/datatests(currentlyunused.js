// depricated file used to create the original working table that fed in static | can be reinstantiated by linking to this file in indexedDB.html and unlinking current main
